...
import net.kodont.booruwallpaperswitcher.TagFragment.OnListFragmentInteractionListener;
...
public class MyTagRecyclerViewAdapter extends RecyclerView.Adapter<MyTagRecyclerViewAdapter.ViewHolder> {
    ...
    public MyTagRecyclerViewAdapter(List<String> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
